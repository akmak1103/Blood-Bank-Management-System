...
<body>
	...
	<div class="signup-form">
		<form action="hospital_update" method="post">
			<h2>Update</h2>
			<p class="hint-text">Make changes to a Hospital Record</p>
			<%!
				Hospital Old_Hospital;
			%>
			<%
			Old_Hospital=new Hospital();
			Old_Hospital = (Hospital)request.getAttribute("Old_Hospital");
			%>
			<div class="form-group">
				<input type="hidden" class="form-control" name="id"
					placeholder="ID" required="required" value="<%=Old_Hospital.getId()%>">
			</div>
			<div class="form-group">
				<input type="text" class="form-control" name="name"
					placeholder="Hospital Name" required="required" value="<%=Old_Hospital.getName()%>">
			</div>
			<div class="form-group">
				<input type="text" class="form-control" name="address"
					placeholder="Address" required="required" value="<%=Old_Hospital.getAddress()%>">
			</div>
			<div class="form-group">
				<input type="text" class="form-control" name="blood_bank"
					placeholder="Blood Bank ID" required="required" value="<%=Old_Hospital.getBlood_bank_id()%>">
			</div>
			<div class="form-group">
				<button type="submit" class="btn btn-danger btn-lg btn-block"
					name="submit" value="update_hospital">Update Hospital</button>
			</div>
		</form>
