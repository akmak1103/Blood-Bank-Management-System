...
<body>
	...
	<div class="signup-form">
		<form action="donor_login" method="post">
			<h2>Register</h2>
			<p class="hint-text">Create your account to save people's lives
				:)</p>
		...
		<div class="text-center">
			Already have an account? <a href="donor_login.jsp"
				style="color: #FE0002; text-decoration: none;">Sign in</a>
		</div>
	</div>
