...
<body>
	...
	<div class="signup-form">
		<form action="donor_update" method="post">
			<h2>Update</h2>
			<p class="hint-text">Update donor details here</p>
			<%!
				Donor Old_Donor;
			%>
			<%
			Old_Donor=new Donor();
			Old_Donor = (Donor)request.getAttribute("Old_Donor");
			%>
			<div class="form-group">
				<input type="text" class="form-control" name="donorname"
					placeholder="Name" required="required" value="<%=Old_Donor.getName()%>">
			</div>
			<div class="form-group">
				<input type="text" class="form-control" name="blood_group"
					placeholder="Blood Group" required="required" value="<%=Old_Donor.getBlood_group()%>">
			</div>
			<div class="form-group">
				<input type="text" class="form-control" name="contact"
					placeholder="Contact Number" required="required" value="<%=Old_Donor.getContact()%>">
			</div>
			<div class="form-group">
				<input type="text" class="form-control" name="address"
					placeholder="Address" required="required" value="<%=Old_Donor.getAddress()%>">
			</div>
			...
			<div class="form-group">
				<input type="hidden" class="form-control" name="username"
					placeholder="Username" required="required" value="<%=Old_Donor.getUsername()%>">
			</div>
			<div class="form-group">
				<input type="password" class="form-control" name="password"
					placeholder="Password" required="required" value="<%=Old_Donor.getPassword()%>">
			</div>
			<div class="form-group">
				<button type="submit" class="btn btn-danger btn-lg btn-block"
					name="submit" value="update_donor">Update</button>
			</div>
			<h6 style="text-align:center;">${successMessage}</h6>
		</form>
	</div>
