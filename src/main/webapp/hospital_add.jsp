...
<body>
	...
	<div class="signup-form">
		<form action="hospital_insert" method="post">
			<h2>Add</h2>
			<p class="hint-text">Create a new Hospital Record</p>
			...
			<div class="form-group">
				<input type="text" class="form-control" name="name"
					placeholder="Hospital Name" required="required">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<input type="text" class="form-control" name="blood_bank"
					placeholder="Blood Bank ID" required="required">
			</div>
			<div class="form-group">
				<button type="submit" class="btn btn-danger btn-lg btn-block"
					name="submit" value="register">Add Hospital</button>
			</div>
		</form>
