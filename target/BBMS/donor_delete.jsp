		...
		<div class="row">
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
				<div class="card card-signin my-5">
					<div class="card-body">
						<h5 class="card-title text-center">Delete Donor</h5>
						<form action="donor_delete" class="form-signin" method="post">
							...
							<button class="btn btn-lg btn-danger btn-block text-uppercase"
								type="submit" name="submit" value="delete">Delete</button>
								<h6></h6>
								<h6></h6>
