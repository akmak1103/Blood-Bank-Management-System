		...
		<div class="row">
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
				<div class="card card-signin my-5">
					<div class="card-body">
						<h5 class="card-title text-center">Search Hospital</h5>
						<form action="hospital_update" class="form-signin" method="post">
							<div class="form-group">
								<input type="text" id="inputEmail" class="form-control py-2"
									name="id" placeholder="Enter ID" required autofocus>
							</div>

							<button class="btn btn-lg btn-danger btn-block"
								type="submit" name="submit" >Update Hospital Details</button>
								<h6></h6>
								<h6></h6>
