...
<body>
	<nav class="navbar navbar-expand-lg navbar-light"
		...
		<a class="navbar-brand" href="#"> <img
			src="./images/save-a-life-give-blood-logo (2).jpg" width="60"
			alt="">
		</a>
			...
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
				<div class="card card-signin my-5">
					...
					<h6 style="text-align:center;">${successMessage}</h6>
						...
						<form action="donor_login" class="form-signin" method="post">
							<div class="form-group">
								<input type="text" id="inputEmail" class="form-control py-2"
									name="username" placeholder="Username" required autofocus>
							</div>

							<div class="form-group">
								<input type="password" id="inputPassword"
									class="form-control py-2" name="password" placeholder="Password" required>
							</div>
							...
							<button class="btn btn-lg btn-danger btn-block text-uppercase"
								type="submit" name="submit" value="sign_in">Sign in</button>
								<h6></h6>
								<h6></h6>
								<h6 style="text-align:center;">${message}</h6>
							<hr class="my-4">
							<div style="text-align: center;"><a href="donor_reg.jsp" style="text-decoration: none; color: red;">Register</a></div>
						</form>
					</div>
				</div>
			</div>
