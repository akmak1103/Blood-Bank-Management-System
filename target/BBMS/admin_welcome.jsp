...
for(Cookie cookie : cookies){
	if(cookie.getName().equals("user")) response.sendRedirect("admin_welcome.jsp");
}
}
%> --%>
	...
	<nav class="navbar navbar-expand-lg navbar-light"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item px-2"><a href="admin_login.jsp"><button
							type="button" class="btn btn-outline-danger">Admin</button></a></li>
	...
	<!-- ADMIN MENU -->
	<h1 class="text-white">Spacing</h1>
	<div class="container">
		<h2>Welcome Admin!</h2>
	</div>
	<h5 class="text-white">Spacing</h5>
	<div class="container">
		<div class="card-deck">
			<div class="card border-danger" style="max-width: 18rem;">
				<div class="card-body">
					...
					<p class="card-text">The blood bank has tie ups with several
						hospitals to provide facilities to their patients.</p>
				</div>
				<div class="card-footer">
					<a href="hospital_add.jsp" class="card-link" style="color:red;">Add</a> <a href="hospital_view" class="card-link" style="color:red;">View</a> 
					<a href="search_hospital_by_id.jsp" class="card-link" style="color:red;">Update</a>
				</div>
			...
			<div class="card border-danger" style="max-width: 18rem;">
				<div class="card-body">
					...
					<!-- <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6> -->
					<p class="card-text">Requests made by visitors coming on our
						website or by the hospital staff.</p>
				</div>
				<div class="card-footer">
					<a href="#" class="card-link" style="color:red;">Add</a> <a href="#" class="card-link" style="color:red;">View</a>
			...
			<div class="card border-danger" style="max-width: 18rem;">
				<div class="card-body">
					...
					<!-- <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6> -->
					<p class="card-text">Places apart from hospital where people
						can get blood in emergency.</p>
				</div>
				<div class="card-footer">
					<a href="#" class="card-link" style="color:red;">Add</a> <a href="#" class="card-link" style="color:red;">View</a>
					<a href="#" class="card-link" style="color:red;">Delete</a>
			...
			<div class="card border-danger" style="max-width: 18rem;">
				<div class="card-body">
					...
					<!-- <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6> -->
					<p class="card-text">People who have donated blood in past or
						have registered for the next blood camp.</p>
				</div>
				<div class="card-footer">
					<a href="search_username.jsp" class="card-link" style="color:red;">Update</a> <a href="donor_view" class="card-link" style="color:red;">View</a>
					<a href="donor_delete.jsp" class="card-link" style="color:red;">Delete</a>
